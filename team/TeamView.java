...
public class TeamView {
    ...
    public void loadTeamPageData() {
        ...
        TableColumn<Team, String> teamIDCol = columnFactory.getTableColumn("teamID", "Team ID", false, 100,
                cellFactory);
        TableColumn<Team, String> teamNameCol = columnFactory.getTableColumn("teamName", "Name", true,
                100,
                cellFactory);
